...
<html lang="en">
    <head>
        ...
        <title>Manage Subject Combinations | Academic Portal</title>
        <!-- Google Fonts -->
                ...
                <main class="flex-1 lg:ml-64 p-6 transition-all duration-300">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 animate-fade-in">
                            <div>
                                <h1 class="text-3xl font-bold font-heading text-white">Manage Subject Combinations</h1>
                                <nav class="flex mt-2 text-sm text-gray-400">
                                    <a href="dashboard.php" class="hover:text-primary transition-colors">Home</a>
                                    <span class="mx-2">/</span>
                                    <span class="text-gray-200">Subject Combinations</span>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="bg-surface border border-white/10 rounded-2xl p-6 shadow-xl animate-slide-up">
                            <h2 class="text-xl font-bold font-heading mb-4 border-b border-white/10 pb-2">Combinations List</h2>
...
{   ?>
                                        <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                            ...
                                            <td class="py-3 px-4 font-medium"><?php echo htmlentities($result->ClassName);?> &nbsp; <?php echo htmlentities($result->ClassNameNumeric);?> &nbsp; Section-<?php echo htmlentities($result->Section);?></td>
                                            ...
                                            <td class="py-3 px-4">
                                                <?php if($stts=='0') { ?>
                                                    <a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="return confirm('Do you really want to activate this subject?');" class="text-emerald-400 hover:text-emerald-300 transition-colors" title="Activate">
                                                        <i class="fa-solid fa-check"></i>
                                                    </a>
                                                <?php } else { ?>
                                                    <a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="return confirm('Do you really want to deactivate this subject?');" class="text-red-400 hover:text-red-300 transition-colors" title="Deactivate">
