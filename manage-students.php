...
<html lang="en">
    <head>
        ...
        <title>Manage Students | Academic Portal</title>
        <!-- Google Fonts -->
        ...
        <!-- DataTables CSS for Tailwind (Optional or Custom) -->
        <!-- We will style the table manually with Tailwind classes, but basic DataTables structure is needed -->
        ...
        <style>
            ...
            .dataTables_wrapper .dataTables_filter input {
                background-color: #1e293b; /* bg-surface */
            ...
            .dataTables_wrapper .dataTables_paginate .paginate_button.current {
                ...
                background: #4f46e5 !important; /* primary */
                ...
                <main class="flex-1 lg:ml-64 p-6 transition-all duration-300">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 animate-fade-in">
                            <div>
                                <h1 class="text-3xl font-bold font-heading text-white">Manage Students</h1>
                                <nav class="flex mt-2 text-sm text-gray-400">
                                    <a href="dashboard.php" class="hover:text-primary transition-colors">Home</a>
                                    <span class="mx-2">/</span>
                                    <span class="text-gray-200">Manage Students</span>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                            ...
                                            <td class="py-3 px-4">
                                                <span class="bg-primary/20 text-primary px-2 py-1 rounded text-xs">
                                                    <?php echo htmlentities($result->ClassName);?>(<?php echo htmlentities($result->ClassNameNumeric);?>-<?php echo htmlentities($result->Section);?>)
                                                </span>
                                            </td>
                                            <td class="py-3 px-4 text-gray-400"><?php echo htmlentities($result->RegDate);?></td>
                                            <td class="py-3 px-4">
                                                <div class="flex items-center gap-2">
                                                    <a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="text-blue-400 hover:text-blue-300 transition-colors" title="Edit">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="delete-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="text-red-400 hover:text-red-300 transition-colors" onclick="return confirm('Are you sure you want to delete this student?');" title="Delete">
