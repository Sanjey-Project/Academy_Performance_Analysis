...
<html lang="en">
    <head>
        ...
        <title>Manage Subjects | Academic Portal</title>
        <!-- Google Fonts -->
                ...
                <main class="flex-1 lg:ml-64 p-6 transition-all duration-300">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 animate-fade-in">
                            <div>
                                <h1 class="text-3xl font-bold font-heading text-white">Manage Subjects</h1>
                                <nav class="flex mt-2 text-sm text-gray-400">
                                    <a href="dashboard.php" class="hover:text-primary transition-colors">Home</a>
                                    <span class="mx-2">/</span>
                                    <span class="text-gray-200">Manage Subjects</span>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="bg-surface border border-white/10 rounded-2xl p-6 shadow-xl animate-slide-up">
                            <h2 class="text-xl font-bold font-heading mb-4 border-b border-white/10 pb-2">Subjects List</h2>
                                ...
                                <table id="example" class="w-full text-left border-collapse">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="py-3 px-4 font-semibold text-sm uppercase tracking-wider text-gray-400">Creation Date</th>
                                            <th class="py-3 px-4 font-semibold text-sm uppercase tracking-wider text-gray-400">Last Updation</th>
...
{   ?>
                                        <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                            ...
                                            <td class="py-3 px-4"><?php echo htmlentities($result->SubjectCode);?></td>
                                            <td class="py-3 px-4"><?php echo htmlentities($result->credit);?></td>
                                            <td class="py-3 px-4"><?php echo htmlentities($result->semester);?></td>
                                            <td class="py-3 px-4 text-gray-400"><?php echo htmlentities($result->Creationdate);?></td>
                                            <td class="py-3 px-4 text-gray-400"><?php echo htmlentities($result->UpdationDate);?></td>
                                            <td class="py-3 px-4">
                                                 <div class="flex items-center gap-2">
                                                    <a href="edit-subject.php?subjectid=<?php echo htmlentities($result->id);?>" class="text-blue-400 hover:text-blue-300 transition-colors" title="Edit">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="delete-subjects.php?subjectid=<?php echo htmlentities($result->id);?>" class="text-red-400 hover:text-red-300 transition-colors" onclick="return confirm('Are you sure you want to delete this subject?');" title="Delete">
