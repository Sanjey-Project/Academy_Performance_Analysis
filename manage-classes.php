...
<html lang="en">
    <head>
        ...
        <title>Manage Classes | Academic Portal</title>
        <!-- Google Fonts -->
                ...
                <main class="flex-1 lg:ml-64 p-6 transition-all duration-300">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="bg-surface border border-white/10 rounded-2xl p-6 shadow-xl animate-slide-up">
                            <h2 class="text-xl font-bold font-heading mb-4 border-b border-white/10 pb-2">Classes List</h2>
                                        ...
                                        <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                            ...
                                            <td class="py-3 px-4">
                                                 <div class="flex items-center gap-2">
                                                    <a href="edit-class.php?classid=<?php echo htmlentities($result->id);?>" class="text-blue-400 hover:text-blue-300 transition-colors" title="Edit">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="delete-class.php?classid=<?php echo htmlentities($result->id);?>" class="text-red-400 hover:text-red-300 transition-colors" onclick="return confirm('Are you sure you want to delete this class?');" title="Delete">
