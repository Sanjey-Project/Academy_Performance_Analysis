...
<html lang="en">
    <head>
        ...
        <title>Manage Faculty | Academic Portal</title>
        <!-- Google Fonts -->
                ...
                <main class="flex-1 lg:ml-64 p-6 transition-all duration-300">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="bg-surface border border-white/10 rounded-2xl p-6 shadow-xl animate-slide-up">
                            <h2 class="text-xl font-bold font-heading mb-4 border-b border-white/10 pb-2">Faculty List</h2>
                                ...
                                <table id="example" class="w-full text-left border-collapse">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="py-3 px-4 font-semibold text-sm uppercase tracking-wider text-gray-400">Faculty Code</th>
                                            <th class="py-3 px-4 font-semibold text-sm uppercase tracking-wider text-gray-400">Qualification</th>
                                            <th class="py-3 px-4 font-semibold text-sm uppercase tracking-wider text-gray-400">Contact</th>
...
{   ?>
                                        <tr class="hover:bg-white/5 transition-colors border-b border-white/5 last:border-0">
                                            ...
                                            <td class="py-3 px-4"><?php echo htmlentities($result->FacultyCode);?></td>
                                            <td class="py-3 px-4"><?php echo htmlentities($result->Qualification);?></td>
                                            <td class="py-3 px-4 text-gray-400"><?php echo htmlentities($result->contact);?></td>
                                            <td class="py-3 px-4">
                                                 <div class="flex items-center gap-2">
                                                    <a href="edit-faculty.php?facultyid=<?php echo htmlentities($result->id);?>" class="text-blue-400 hover:text-blue-300 transition-colors" title="Edit">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <a href="delete-faculty.php?facultyid=<?php echo htmlentities($result->id);?>" class="text-red-400 hover:text-red-300 transition-colors" onclick="return confirm('Are you sure you want to delete this faculty member?');" title="Delete">
